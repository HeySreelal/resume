...
\customcventry{04/2021 ‐ 07/2021}{{\color{blue}\href{https://pokitqr.com/}{GrocsKart}}}{Flutter Intern,}{Kochi, Kerala}{}{
    {\begin{itemize}[leftmargin=0.6cm, label={\textbullet}]
                \item Contributed to the development of GrocsKart, an e-commerce app built with Flutter.
                \item Implemented Provider for state management and Firebase for backend services.
                \item Implemented Firebase tools, including storage for store uploads (Firebase Storage), scalable NoSQL database (Firestore), and push notifications (Firebase Messaging).
                \item Integrated Razorpay for secure in-app payments and implemented push notifications for better user engagement.
            \end{itemize}}}
